...
export const STATIC_I18N_KEYS = [
  ...
  // Playground dynamic prompts and input tools
  'Analyze data',
  'Summarize text',
  'Code',
  'Get advice',
  ...
  // Parameter override visual editor dynamic labels
  'Set Field',
  'Delete Field',
  'Append to End',
  'Prepend to Start',
  ...
  'Write value to the target field',
  'Remove the target field',
  'Append value to array / string / object end',
  'Prepend value to array / string / object start',
  'Copy source field to target field',
  'Move source field to target field',
  'Do string replacement in the target field',
  'Do regex replacement in the target field',
  'Remove string prefix',
  'Remove string suffix',
  'Ensure the string has a specified prefix',
  'Ensure the string has a specified suffix',
  'Trim leading/trailing whitespace',
  'Convert string to lowercase',
  'Convert string to uppercase',
  'Return a custom error immediately',
  'Prune object items by conditions',
  'Pass specified request headers to upstream',
  'Auto-fill when one field exists and another is missing',
  'Set runtime request header: override entire value, or manipulate comma-separated tokens',
  'Delete a runtime request header',
  'Copy a request header',
  'Move a request header',
  'Header Name',

...
func validateChannel(channel *model.Channel, isAdd bool) error {
	...
	if channel.Type == constant.ChannelTypeTMLabSeedance && strings.TrimSpace(channel.GetBaseURL()) == "" {
		return fmt.Errorf("TMLab Seedance channel base URL cannot be empty")
	}

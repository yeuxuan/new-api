...
type TaskBillingContext struct {
	...
	TieredBillingSnapshot *billingexpr.BillingSnapshot `json:"tiered_billing_snapshot,omitempty"` // 动态计费规则快照
	TieredSnapshot        *billingexpr.BillingSnapshot `json:"tiered_snapshot,omitempty"`
}

func (c *TaskBillingContext) normalizeTieredSnapshot() {
	if c == nil {
		return
	}
	if c.TieredSnapshot == nil {
		c.TieredSnapshot = c.TieredBillingSnapshot
	}
	if c.TieredBillingSnapshot == nil {
		c.TieredBillingSnapshot = c.TieredSnapshot
	}
}

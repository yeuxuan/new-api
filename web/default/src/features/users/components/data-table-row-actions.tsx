...
import { UserQuotaLogsDialog } from './dialogs/user-quota-logs-dialog'
...
export function DataTableRowActions({ row }: DataTableRowActionsProps) {
  ...
  const [quotaLogsDialogOpen, setQuotaLogsDialogOpen] = useState(false)
  ...
  return (
    <div className='-ml-1.5 flex items-center gap-1'>
      ...
      <UserQuotaLogsDialog
        open={quotaLogsDialogOpen}
        onOpenChange={setQuotaLogsDialogOpen}
        user={{ id: user.id, username: user.username }}
      />
    </div>
  )

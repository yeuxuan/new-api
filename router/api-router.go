...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.GET("/pricing/model_document", middleware.DisableCache(), middleware.HeaderNavModuleAuth("pricing"), controller.GetModelAPIDocument)
		...
		apiRouter.POST("/ipaynow/notify", anonymousRequestBodyLimit, controller.IPayNowNotify)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/ipaynow/amount", controller.RequestIPayNowAmount)
				selfRoute.POST("/ipaynow/pay", middleware.CriticalRateLimit(), controller.RequestIPayNowPay)
				selfRoute.GET("/ipaynow/order/:trade_no", controller.QueryIPayNowOrder)
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.POST("/checkin/clear/preview", controller.AdminPreviewClearCheckinQuota)
				adminRoute.POST("/checkin/clear", controller.AdminClearCheckinQuota)

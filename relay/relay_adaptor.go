...
import (
	...
	tasktmlabseedance "github.com/QuantumNous/new-api/relay/channel/task/tmlabseedance"
...
func GetTaskAdaptor(platform constant.TaskPlatform) channel.TaskAdaptor {
	if platform == constant.TaskPlatform(strconv.Itoa(constant.ChannelTypeTMLabSeedance)) {
		return &tasktmlabseedance.TaskAdaptor{}
	}
...
func getTaskAdaptorForRequest(c *gin.Context, platform constant.TaskPlatform) (constant.TaskPlatform, channel.TaskAdaptor) {
	if platform == constant.TaskPlatform(strconv.Itoa(constant.ChannelTypeTMLabSeedance)) {
		return platform, &tasktmlabseedance.TaskAdaptor{}
	}
	if c != nil {

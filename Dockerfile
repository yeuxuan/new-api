...
RUN go build -ldflags "-s -w -X 'github.com/QuantumNous/new-api/common.Version=$(cat VERSION)'" -o conversation-archive ./cmd/conversation-archive
...
COPY --from=builder2 /build/conversation-archive /
